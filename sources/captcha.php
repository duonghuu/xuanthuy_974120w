...
class CaptchaSecurityImages { 
  ...
  function CaptchaSecurityImages($width = 145,$height = 35, $characters = 6) { 
    ...
    /* set the colours */ 
    //$bgR = mt_rand(255, 255); $bgG = mt_rand(255, 255); $bgB = mt_rand(255, 255); 
    $background_color = imagecolorallocate($image, $bgR, $bgG, $bgB); 
    //$noise_color = imagecolorallocate($image, abs(0 - $bgR), abs(2505 - $bgG), abs(0 - $bgB)); 
...
$captcha = new CaptchaSecurityImages(120, 33, rand(4, 6)); 
