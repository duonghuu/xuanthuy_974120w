...
<form name="supplier" id="validate" class="form" action="index.php?com=place&act=save_street&id_city=<?=$_REQUEST['id_city']?>&id_dist=<?=$_REQUEST['id_dist']?>" method="post" enctype="multipart/form-data">
    <div class="widget">
