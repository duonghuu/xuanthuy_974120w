   ...
   <?php for($i=0, $count=count($items); $i<$count; $i++){?>
      <tr>
        ...
        <td class="title_name_data">
            <a href="index.php?com=place&act=edit_ward&id=<?=$items[$i]['id']?>&id_city=<?=$items[$i]['id_city']?>&id_dist=<?=$items[$i]['id_dist']?>" class="tipS SC_bold"><?=$items[$i]['ten']?></a>
        </td>
        <td align="center">
     ...
     <td class="actBtns">
        <a href="index.php?com=place&act=edit_ward&id=<?=$items[$i]['id']?>&id_city=<?=$items[$i]['id_city']?>&id_dist=<?=$items[$i]['id_dist']?>" title="" class="smallButton tipS" original-title="Sửa"><img src="./images/icons/dark/pencil.png" alt=""></a>
