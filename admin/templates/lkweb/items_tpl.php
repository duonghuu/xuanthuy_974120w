...
<table cellpadding="0" cellspacing="0" width="100%" class="sTable withCheck mTable" id="checkAll">
  <thead>
    <tr>
      ...
      <?php if($_GET["type"]=="mxhle" || $_GET["type"]=="mxh" || $_GET["type"]=="mxhft"){ ?>
  ...
  <tbody>
   ...
   <?php if($_GET["type"]=="mxhle" || $_GET["type"]=="mxh" || $_GET["type"]=="mxhft"){ ?>
     <td align="center">
         <a href="index.php?com=lkweb&act=edit&type=<?=$_REQUEST['type']?>&id=<?=$items[$i]['id']?><?php if($_REQUEST['p']!='') echo'&p='.$_REQUEST['p'];?>" class="tipS SC_bold"><img src="<?=_upload_khac.$items[$i]['photo']?>" style="max-height:40px; max-width:70px;" /></a>
     </td>
   <?php } ?>
   <td class="title_name_data">
    <a href="index.php?com=lkweb&act=edit&type=<?=$_REQUEST['type']?>&id=<?=$items[$i]['id']?><?php if($_REQUEST['p']!='') echo'&p='.$_REQUEST['p'];?>" class="tipS SC_bold"><?=$items[$i]['link']?></a>
  </td>
  <td align="center">
