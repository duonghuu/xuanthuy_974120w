...
<div class="wrapper">
 ...
 <form name="supplier" id="validate" class="form" action="index.php?com=yahoo&act=save<?php if($_REQUEST['curPage']!='') echo'&curPage='.$_REQUEST['curPage'];?>&type=<?=$_REQUEST['type']?>" method="post" enctype="multipart/form-data">
   ...
   <div class="formRow">
    <label>Email</label>
    <div class="formRight">
     <input type="text" name="email" title="Nhập nội dung" id="email" class="tipS validate[required]" value="<?=@$item['email']?>" />
   </div>
   <div class="clear"></div>
 </div>
 <div class="formRow none">
  <label>Zalo</label>
  <div class="formRight">
   <input type="text" name="yahoo" title="Nhập nội dung" id="yahoo" class="tipS validate[required]" value="<?=@$item['yahoo']?>" />
 </div>
 <div class="clear"></div>
</div>
<div class="formRow none">
