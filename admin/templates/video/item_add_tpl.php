<div class="control_frm" style="margin-top:25px;">
  <div class="bc">
    <ul id="breadcrumbs" class="breadcrumbs">
      <li><a href="index.php?com=video&act=man&type=<?=$_REQUEST['type']?>"><span>Video</span></a></li>
...
<form name="supplier" id="validate" class="form" action="index.php?com=video&act=save<?php if($_REQUEST['curPage']!='') echo'&curPage='.$_REQUEST['curPage'];?>&type=<?=$_REQUEST['type']?>" method="post" enctype="multipart/form-data">
 <div class="widget">
 ...
 <div class="formRow none">
        ...
        <div class="formRight">
          ...
          <div class="note">Width:480px | Height:400px <?=_format_duoihinh_l?> </div>
        </div>
        <div class="clear"></div>
      </div>
  <div class="formRow">
