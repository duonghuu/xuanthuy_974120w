...
<script language="javascript">
	function select_onchange()
	{
		...
		window.location ="index.php?com=news&act=<?php if($_REQUEST['act']=='edit_cat') echo 'edit_cat'; else echo 'add_cat';?><?php if($_REQUEST['id']!='') echo"&id=".$_REQUEST['id']; ?>&type=<?=$_REQUEST['type']?>&id_danhmuc="+a.value;
		return true;
	}
	...
	function select_onchange1()
	{
		...
		window.location ="index.php?com=news&act=<?php if($_REQUEST['act']=='edit_cat') echo 'edit_cat'; else echo 'add_cat';?><?php if($_REQUEST['id']!='') echo"&id=".$_REQUEST['id']; ?>&type=<?=$_REQUEST['type']?>&id_danhmuc="+a.value+"&id_list="+b.value;
		return true;
	}
</script>
