...
<div class="control_frm" style="margin-top:25px;">
    <div class="bc">
        <ul id="breadcrumbs" class="breadcrumbs">
        	            <li><a href="index.php?com=httt&act=man&type=<?=$_REQUEST['type']?>"><span>Liên kết website</span></a></li>
                                    <li class="current"><a href="#" onclick="return false;">Thêm</a></li>
        </ul>
        <div class="clear"></div>
    </div>
</div>
<form name="supplier" id="validate" class="form" action="index.php?com=httt&act=save&type=<?=$_REQUEST['type']?>" method="post" enctype="multipart/form-data">
       ...
       <div id="info" class="tab_content">
           ...
           <div class="formRow">
                           ...
                           <div class="formRight">
                               ...
                               <div class="note"> Width:30px | Height:30px<?=_format_duoihinh_l?> </div>
                           </div>
                           <div class="clear"></div>
                       </div>
                       ...
                       <div class="formRow">
                           ...
                           <div class="mt10"><img src="<?=_upload_khac.$item['photo']?>" style="max-width:100px;" /></div>
