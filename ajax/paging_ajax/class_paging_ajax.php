...
class paging_ajax
{
    ...
    public function GetResult()
    {
        ...
        $result = get_result($this->text_sql);
        $this->num_row = $d->num_rows();
        // LẤY KẾT QUẢ TRANG HIỆN TẠI
        // $d->query($this->text_sql." LIMIT $start, $this->per_page");
        $rs = get_result($this->text_sql." LIMIT $start, $this->per_page");
    ...
    public function Load()
    {
        ...
        if ($this->cur_page >= 15) {
            ...
            else if ($this->cur_page <= $no_of_paginations && $this->cur_page > $no_of_paginations - 15) {
                $start_loop = $no_of_paginations - 15;
