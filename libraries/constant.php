<?php if(!@defined('_lib')) die("Error");
	...
	#========= Thông tin nhân viên ==============
	@define ( _contact_email , "phuongvunina@gmail.com" );
	@define ( _contact_yahoo , "phuongdeptraiit" );
	@define ( _contact_skype , "phuongdeptraiit" );
	@define ( _contact_phone , "0167.606.9683" );	
	...
	@define ( _format_duoihinh , "jpg|png|jpeg|gif|ico|JPG|PNG|JPEG|GIF|ICO");
	...
	@define ( _format_duoitailieu_l , "<strong> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; .doc, .xls, .ppt, .pdf, .rar, .win, .zip , .docx, .pptx, .xlsx &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</strong>");
