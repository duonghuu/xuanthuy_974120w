...
class JsonsChema {
	...
	public function Library(){
		...
		"@context": "http://schema.org/",
			...
			"image": "'._BASEURL_._upload_hinhanh_l.$Favicon['photo'].'",
			"priceRange":"FREE",
			"hasMap": "https://www.google.com/maps/place/Thi%E1%BA%BFt+K%E1%BA%BF+-+Thi+C%C3%B4ng+Qu%C3%A1n+Cafe+,+Tr%C3%A0+S%E1%BB%AFa+%C4%90%E1%BA%B9p+%7C+Stdecor/@10.831472,106.662542,15z/data=!4m5!3m4!1s0x0:0xab367ea735875d6f!8m2!3d10.831472!4d106.662542",	
			"email": "mailto:'.$Setting['email'].'",
		  	"address": {
		    	...
		    	"postalCode":"700000",
		    	"streetAddress": "79/52 Đường Thống Nhất, Phường 11"
		  	},
		  	"description": "'.$Setting['description'].'",
		  	"telephone": "+84 '.$Setting['hotline'].'",
		  	"geo": {
		    	"@type": "GeoCoordinates",
		   		"latitude": "'.trim($map[0]).'",
		...
		$html = '<script type="application/ld+json">
		{
		  ...
		  "author": {
		   ...
		   "publisher": {
		    ...
		    "logo": {
		      "@type": "ImageObject",
		      "url": "'._BASEURL_._upload_hinhanh_l.$Favicon['photo'].'"
		    }
		  },
	...
	public function Organization(){
		...
		{ "@context" : "http://schema.org",
		  ...
		  "logo":"'._BASEURL_._upload_hinhanh_l.$Favicon['photo'].'",
		  "contactPoint" : [
		    {
		      "@type" : "ContactPoint",
		      "telephone" : "+84 '.$Setting['hotline'].'",
